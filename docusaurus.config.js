...
const config = {
  ...
  baseUrl: "/es-user-guide-solo/",

  // GitHub pages deployment config.
  // If you aren't using GitHub pages, you don't need these.
  organizationName: "rugwu", // Usually your GitHub org/user name.
  projectName: "es-user-guide-solo", // Usually your repo name.
      ...
      "docusaurus-plugin-openapi-docs",
      {
        ...
        config: {
          customerExperienceApi: {
            specPath: "static/api-specification/customer-experience-suite.yaml",
            outputDir: "docs/es-loyalty/api/customer-experience-api",
            sidebarOptions: {
              groupPathsBy: "tag",
          ...
          partnerProgramsApi: {
            specPath: "static/api-specification/partner-program-suite.yaml",
            outputDir: "docs/es-loyalty/api/partner-programs-api",
            sidebarOptions: {
              groupPathsBy: "tag",
              categoryLinkSource: "info",
            },
          ...
          pointOfSaleApi: {
            specPath: "static/api-specification/point-of-sale-suite.yaml",
            outputDir: "docs/es-loyalty/api/point-of-sale-api",
            sidebarOptions: {
              groupPathsBy: "tag",
              categoryLinkSource: "info",
            },
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          {
            to: "/docs/es-loyalty/release-notes",
            position: "left",
            label: "Release Notes",
          },
          // {
